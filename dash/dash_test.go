...
func Test_Audio(t *testing.T) {
   for _, name := range tests {
      ...
      target := slices.Index(reps, func(r Representation) bool {
...
func Test_Video(t *testing.T) {
   for _, name := range tests {
      ...
      slices.Sort(reps, func(a, b Representation) int {
         return int(b.Bandwidth - a.Bandwidth)
      })
      target := slices.Index(reps, func(a Representation) bool {
...
func Test_Info(t *testing.T) {
   for _, name := range tests {
      ...
      fmt.Println(name)
      reps = slices.Delete(reps, func(r Representation) bool {
         if Audio(r) {
            return false
         }
         if Video(r) {
